...
//         console.log(samp)
//         console.log("sdfsf",req.body.name)
...
//         const fetchCategories = await categoryFromDB.find()
//         // console.log(fetchCategories[0].category_name)


//         const fetchProducts = await productModel.find().populate('category_id').sort({ createdAt: -1 , updatedAt: -1})
   


//         res.render("productList" , {categories : fetchCategories , products:fetchProducts})
        
//     } catch (error) {
//         console.log("error from loadProductPage")
//     }
// }
